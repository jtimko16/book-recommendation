...
# Function to extract the dominant color using k-means clustering
...
def infer_mood_from_color(dominant_color):
...
def plot_dominant_color(dominant_color):
...
def process_book_cover(image):
    ...
    # Plot dominant color (for visualization)
